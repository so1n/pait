...
urlpatterns = [route_path("api/demo/<int:age>", demo_route, ["POST"], name="demo")]


if __name__ == "__main__":
    run_urlpatterns(urlpatterns, "docs_source_code.introduction.how_to_use_field.django_demo_urlconf")

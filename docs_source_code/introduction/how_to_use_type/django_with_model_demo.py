...
@pait()
def demo(demo_model: DemoModel = field.Query.i(raw_return=True)) -> JsonResponse:
    return JsonResponse(demo_model.dict())


@pait()
def demo1(demo_model: DemoModel = field.Json.i(raw_return=True)) -> JsonResponse:
    return JsonResponse(demo_model.dict())
...
if __name__ == "__main__":
    run_urlpatterns(urlpatterns, "docs_source_code.introduction.how_to_use_type.django_with_model_demo_urlconf")

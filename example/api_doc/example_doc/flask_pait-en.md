...
- Response:
    ...
    - AutoCompleteRespModel
        ...
        - Response Data
            ...
            |---|---|---|---|---|---|
            |code|integer| | |api code||
            |data.image_list|array|**`Required`**| |music list|[`items:{'type': 'object'}`]|
            |data.music_list.name|string| | | ||
            |data.music_list.singer|string| | | ||
            |data.music_list.url|string|**`Required`**| | ||

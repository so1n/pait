...
### Name: pait.async_text_response_route

- API Info

    |Author|Status|Func|Summary|
    |---|---|---|---|
    |so1n    |undefined    |<abbr title="file:/home/so1n/github/pait/example/param_verify/sanic_example.py;line: 381">async_text_response_route</abbr>|    |
- Path: api/text-resp
- Method: GET
- Request:
- Response:

...
from example.example_grpc.python_example_proto_code.example_proto_by_option.book import manager_pb2 as example__proto__by__option_dot_book_dot_manager__pb2
...
def add_BookManagerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'create_book': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=example__proto__by__option_dot_book_dot_manager__pb2.CreateBookRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'delete_book': grpc.unary_unary_rpc_method_handler(
                    servicer.delete_book,
                    request_deserializer=example__proto__by__option_dot_book_dot_manager__pb2.DeleteBookRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'get_book': grpc.unary_unary_rpc_method_handler(
                    servicer.get_book,
                    request_deserializer=example__proto__by__option_dot_book_dot_manager__pb2.GetBookRequest.FromString,
                    response_serializer=example__proto__by__option_dot_book_dot_manager__pb2.GetBookResult.SerializeToString,
            ),
            'get_book_list': grpc.unary_unary_rpc_method_handler(
                    servicer.get_book_list,
                    request_deserializer=example__proto__by__option_dot_book_dot_manager__pb2.GetBookListRequest.FromString,
                    response_serializer=example__proto__by__option_dot_book_dot_manager__pb2.GetBookListResult.SerializeToString,
            ),
    }

...
from example.example_grpc.python_example_proto_code.example_proto_by_option.book import social_pb2 as example__proto__by__option_dot_book_dot_social__pb2
...
def add_BookSocialServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'like_book': grpc.unary_unary_rpc_method_handler(
                    servicer.like_book,
                    request_deserializer=example__proto__by__option_dot_book_dot_social__pb2.LikeBookRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'like_multi_book': grpc.unary_unary_rpc_method_handler(
                    servicer.like_multi_book,
                    request_deserializer=example__proto__by__option_dot_book_dot_social__pb2.LikeBookMapRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            ...
            'comment_book': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=example__proto__by__option_dot_book_dot_social__pb2.CommentBookRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
            'get_book_comment': grpc.unary_unary_rpc_method_handler(
                    servicer.get_book_comment,
                    request_deserializer=example__proto__by__option_dot_book_dot_social__pb2.GetBookCommentRequest.FromString,
                    response_serializer=example__proto__by__option_dot_book_dot_social__pb2.GetBookCommentListResult.SerializeToString,
            ),
    }

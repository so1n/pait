...
class GetBookCommentRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["isbn",b"isbn","limit",b"limit","next_create_time",b"next_create_time"]) -> None: ...
...
class NestedGetBookLikesRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    NESTED_FIELD_NUMBER: builtins.int
    @property
    def nested(self) -> global___GetBookLikesRequest: ...
    def __init__(self,
        *,
        nested: typing.Optional[global___GetBookLikesRequest] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["nested",b"nested"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["nested",b"nested"]) -> None: ...
global___NestedGetBookLikesRequest = NestedGetBookLikesRequest

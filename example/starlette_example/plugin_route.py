...
async def unified_html_response() -> str:
...
async def unified_text_response() -> str:
    return "Demo"
...
async def unified_json_response() -> dict:
    return {"data": "Demo"}
...
if __name__ == "__main__":
    with create_app() as app:
        ...
        app.add_route("/api/unified-json-response", unified_json_response, methods=["GET"])
        app.add_route("/api/unified-text-response", unified_text_response, methods=["GET"])
        app.add_route("/api/unified-html-response", unified_html_response, methods=["GET"])

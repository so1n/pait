...
class TestFlask:
    ...
    def test_gen_response(self, base_test: BaseTest) -> None:
        ...
        from pait.app.flask.adapter.response import gen_response, gen_unifiled_response
        from pait.model import response

        for gen_method in (gen_response, gen_unifiled_response):
            result = gen_method(jsonify({"demo": 1}), response_model_class=response.BaseResponseModel)
...
class TestDocExample:
    ...
    def test_streaming_file_secure_upload_demo(self) -> None:
        ...
        with client_ctx(app=flask_secure_upload_demo.app) as client:
            BaseTestDocExample(client, _TestHelper).streaming_file_secure_upload_demo(
                flask_secure_upload_demo.secure_upload
            )
    ...
    def test_streaming_file_upload_progress_demo(self) -> None:
        ...
        with client_ctx(app=flask_upload_progress_demo.app) as client:
            BaseTestDocExample(client, _TestHelper).streaming_file_upload_progress_demo(
                flask_upload_progress_demo.upload_with_progress
            )
    ...
    def test_api_route_basic_demo(self) -> None:
        ...
        with client_ctx(app=flask_basic_demo.app) as client:
            BaseTestDocExample(client, _TestHelper).api_route_basic_demo(
                flask_basic_demo.get_users,
                flask_basic_demo.create_user,
                flask_basic_demo.get_user,
            )
    ...
    def test_api_route_dynamic_route_demo(self) -> None:
        ...
        with client_ctx(app=flask_dynamic_route_demo.app) as client:
            BaseTestDocExample(client, _TestHelper).api_route_dynamic_route_demo(flask_dynamic_route_demo.greet)
    ...
    def test_api_route_advanced_demo(self) -> None:
        ...
        with client_ctx(app=flask_advanced_demo.app) as client:
            BaseTestDocExample(client, _TestHelper).api_route_advanced_demo(
                flask_advanced_demo.get_profile,
                flask_advanced_demo.login,
                flask_advanced_demo.OrderAPIView.get,
            )
    ...
    def test_api_route_cbv_demo(self) -> None:
        ...
        with client_ctx(app=flask_cbv_demo.app) as client:
            BaseTestDocExample(client, _TestHelper).api_route_cbv_demo(flask_cbv_demo.UserAPIView)
    ...
    def test_api_route_config_inherit_demo(self) -> None:
        ...
        with client_ctx(app=flask_config_inherit_demo.app) as client:
            BaseTestDocExample(client, _TestHelper).api_route_config_inherit_demo(flask_config_inherit_demo.get_profile)
    ...
    def test_api_route_framework_extra_demo(self) -> None:
        ...
        with client_ctx(app=flask_framework_extra_demo.app) as client:
            BaseTestDocExample(client, _TestHelper).api_route_framework_extra_demo(flask_framework_extra_demo.health)

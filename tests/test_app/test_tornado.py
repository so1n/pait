...
class TestTornado(BaseTestTornado):
    ...
    def test_mcp_route(self) -> None:
        assert_mcp_route(TornadoMCPHTTPClient(self), "tornado-example", support_http_dispatcher=False)
...
class TestDocAPIRouteBasicExample(BaseTestTornadoDocExample):
    ...
    def test_api_route_basic_demo(self) -> None:
        BaseTestDocExample(self, _TestHelper).api_route_basic_demo(
            self.demo.get_users,
            self.demo.create_user,
            self.demo.get_user,
        )
...
class TestDocAPIRouteDynamicRouteExample(BaseTestTornadoDocExample):
    ...
    def test_api_route_dynamic_route_demo(self) -> None:
        BaseTestDocExample(self, _TestHelper).api_route_dynamic_route_demo(self.demo.greet)
...
class TestDocAPIRouteAdvancedExample(BaseTestTornadoDocExample):
    ...
    def test_api_route_advanced_demo(self) -> None:
        BaseTestDocExample(self, _TestHelper).api_route_advanced_demo(
            self.demo.get_profile,
            self.demo.login,
            self.demo.OrderAPIView.get,
        )
...
class TestDocAPIRouteCBVExample(BaseTestTornadoDocExample):
    ...
    def test_api_route_cbv_demo(self) -> None:
        BaseTestDocExample(self, _TestHelper).api_route_cbv_demo(self.demo.UserAPIView)
...
class TestDocAPIRouteConfigInheritExample(BaseTestTornadoDocExample):
    ...
    def test_api_route_config_inherit_demo(self) -> None:
        BaseTestDocExample(self, _TestHelper).api_route_config_inherit_demo(self.demo.get_profile)
...
class TestDocAPIRouteFrameworkExtraExample(BaseTestTornadoDocExample):
    ...
    def test_api_route_framework_extra_demo(self) -> None:
        BaseTestDocExample(self, _TestHelper).api_route_framework_extra_demo(self.demo.health)

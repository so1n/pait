...
__all__ = ["config", "pait_data", "get_ctx", "set_ctx"]

###########
# Context #
###########
_pait_context: ContextVar["ContextModel"] = ContextVar("pait_context")


def get_ctx() -> "ContextModel":
    return _pait_context.get()


def set_ctx(context_model: "ContextModel") -> None:
    _pait_context.set(context_model)

...
class PaitCallParamTypedDict(PaitCreateSubParamTypedDict, total=False):
    """
...
def easy_to_develop_merge_kwargs(
    base_param: PaitInitParamTypedDict, use_param: PaitCreateSubParamTypedDict
...
class Pait(object):
    ...
    def __call__(self, **kwargs: Unpack[PaitCallParamTypedDict]) -> Callable:
        """
